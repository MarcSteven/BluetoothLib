...
class ServiceModelManager: NSObject, CBPeripheralDelegate {
    ...
    fileprivate(set) var registeredServiceModels: [BluetoothModel]
     ...
     */
    func register(serviceModel: BluetoothModel) {
    ...
    */
     ...
     */
    func setNotify(serviceModel: BluetoothModel, enabled: Bool, characteristicUUID: String) {
     ...
     */
    fileprivate func serviceModel(withUUID uuid: String) -> BluetoothModel? {
