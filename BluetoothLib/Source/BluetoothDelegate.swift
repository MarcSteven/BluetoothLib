 ...
 */
@objc public protocol BluetoothDelegate : AnyObject {
    /**
  ...
  @objc   optional func didUpdateState(_ state: CBManagerState)
    ...
    */
    ...
    /** called when the BluetoothManager did find a peripheral and did add it to the found device array*/
    
    @objc optional func didFindDevice(_ bluetoothManager:BluetoothManager,
                                      andFindDevice device:BluetoothDevice)
